...
func (_m *DeckUsecase) Create(ctx context.Context, isShuffled bool, cardsList []string) response.ResultData {
...
func (_m *DeckUsecase) Draw(ctx context.Context, deckUUID string, count int) response.ResultData {
...
func (_m *DeckUsecase) FindByID(ctx context.Context, deckUUID string) response.ResultData {
